...
namespace Proyecto_MAD
{
    public partial class ReporteVentas : Form
    {
        ...
        private void CargarReporte(string pais, string ciudad, string Hotel, int? year)
        {
            var obj = new EnlaceDB();
            var table = new DataTable();
            table = obj.ReporteVentas(pais, ciudad, Hotel, year);
            GrdReporte.DataSource = table;
            GrdReporte.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
            GrdReporte.Columns["NumMes"].Visible = false;
        }
        private void btnFiltrarHot_Click(object sender, EventArgs e)
        {
            ...
            CargarReporte(pais, ciudad, Hotel, Year);
        }
    }
}
